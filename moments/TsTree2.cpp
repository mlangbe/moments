...
int TsTree2::numbersummed=0;
int TsTree2::ptssummed=0;
/**
get All tsets of the blocks in a certain height
Action is a functor which takes three integers as input
*/
void TsTree2::getBallTsets(
													std::vector<TsTree2::tset> &inner,
													std::vector<TsTree2::tset> &border,
...
*/
TsTree2::TsTree2(const std::vector<long double> & pts,long double boxwidth,int ptperleaf)
{
	...
	impl::buildFromPoints(*this,pts,boxwidth,ptperleaf);

}



void TsTree2::sumInCircle(
															...
															) const
{
    ...
    //for small numbers, the single-radius procedure is faster
		...
		TsTree2::impl::treeWalker<TsTree2::impl::sumInCircleMultiRadiiAction> w(*this);
		vector<mynum> rsq(n);
...
/*
long double TsTree2::fractdim() const
{
	struct rec
	{
